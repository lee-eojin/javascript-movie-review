(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))c(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const d of a.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&c(d)}).observe(document,{childList:!0,subtree:!0});function r(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function c(s){if(s.ep)return;s.ep=!0;const a=r(s);fetch(s.href,a)}})();const L="https://api.themoviedb.org/3",S="53582fed17d630068894f05310efec62";async function m(e,t,r=""){const c=new URLSearchParams({api_key:S,language:"ko-KR",page:String(t),...r&&{query:r}}),s=await fetch(`${L}/${e}?${c}`);if(!s.ok)throw new Error(`API 요청 실패: ${s.status}`);return await s.json()}const f="movie/popular",y="search/movie";async function p(e,t){return t?await m(y,e,t):await m(f,e,t)}async function b(e,t){try{return await p(e,t)}catch{throw new Error("영화 데이터를 불러오는 중 오류가 발생했습니다.")}}async function w(e){try{return await p(e)}catch{throw new Error("영화 데이터를 불러오는 중 오류가 발생했습니다.")}}async function O(e,t){try{return await p(e,t)}catch{throw new Error("영화 데이터를 불러오는 중 오류가 발생했습니다.")}}class C{listeners=new Map;subscribe(t,r){this.listeners.has(t)||this.listeners.set(t,[]),this.listeners.get(t).push(r)}publish(t,r){this.listeners.get(t)?.forEach(c=>c(r))}}const n=new C,o={LOAD_START:"loadStart",MOVIES_LOADED:"moviesLoaded",SEARCH_LOADED:"searchLoaded",MORE_LOADED:"moreLoaded",TITLE_CHANGED:"titleChanged",LOGO_CLICK:"logoClick"},i={page:1,searchQuery:""};async function h(e){n.publish(o.TITLE_CHANGED,"지금 인기 있는 영화"),n.publish(o.LOAD_START,void 0);const t=await w(e);n.publish(o.MOVIES_LOADED,t)}async function M(e,t){n.publish(o.TITLE_CHANGED,`"${t}" 검색 결과`),n.publish(o.LOAD_START,void 0);const r=await O(e,t);n.publish(o.SEARCH_LOADED,r)}async function R(e,t){const r=await b(e,t);n.publish(o.MORE_LOADED,r)}async function x(e){if(i.page=1,i.searchQuery=e,e===""){await h(i.page);return}await M(i.page,e)}const v="data:image/png;base64,",V="data:image/png;base64,",D="data:image/png;base64,",T="https://image.tmdb.org/t/p/w1920_and_h800_multi_faces/",Y="https://media.themoviedb.org/t/p/w200",A={clearHeader(){const e=document.querySelector(".background-container");e.innerHTML="",e.style.background="none",e.style.height="100px"},render(e){if(!e)return;const t=document.querySelector(".background-container");t.innerHTML=`
            ...
            ${this.renderImage()}
      `,t.style.background=`url(${T}${e.backdrop_path}) no-repeat center center / cover`,t.style.removeProperty("height")},renderSearch(){const e=document.querySelector(".background-container");e.innerHTML=`${this.renderImage()}`},renderImage(){return`<div class="overlay" aria-hidden="true">
            ...
            </div>`}};class U{movie;constructor(t){this.movie=t}render(){return`<div class="item">
      <img
         class="thumbnail"
         src="${Y}${this.movie.poster_path}"
    ...
    `}}class I{render(){return`<div class="movie-skeleton">
    ...
    `}}const N="/javascript-movie-review/assets/Nosearch-9C2OvmM-.png";class Q{movieList;movieContainer;constructor(){this.movieList=document.querySelector(".thumbnail-list"),this.movieContainer=document.querySelector(".main-result")}showEmpty(){this.movieContainer.innerHTML=`
      <div class="result-none">
        <img src="${N}" alt="검색 결과 없음" class="result-none-image" />
        <p class="result-none-text">검색 결과가 없습니다.</p>
      </div>
    `}clearList(){this.movieList.innerHTML="",this.movieContainer.innerHTML=""}renderSkeleton(){this.clearList();for(let t=0;t<20;t++){const r=document.createElement("li"),c=new I;r.innerHTML=c.render(),this.movieList?.append(r)}}renderMovieList(t){t.results.forEach(r=>{const c=document.createElement("li"),s=new U(r);c.innerHTML=s.render(),this.movieList?.append(c)})}}const l=new Q;function u(e,t,r){e.style.display=t===r?"none":"block"}function g(){const e=document.querySelector(".logo");e&&e.addEventListener("click",()=>{n.publish(o.LOGO_CLICK,void 0)},{once:!0})}function G(e,t){n.subscribe(o.LOGO_CLICK,async()=>{i.page=1,i.searchQuery="",await h(i.page)}),n.subscribe(o.TITLE_CHANGED,r=>{t.textContent=r}),n.subscribe(o.LOAD_START,()=>{l.renderSkeleton()}),n.subscribe(o.MOVIES_LOADED,r=>{A.clearHeader(),A.render(r.results[0]??null),g(),l.clearList(),l.renderMovieList(r),u(e,r.total_pages,i.page)}),n.subscribe(o.SEARCH_LOADED,r=>{A.clearHeader(),A.renderSearch(),g(),r.results.length===0?(l.clearList(),l.showEmpty()):(l.clearList(),l.renderMovieList(r)),u(e,r.total_pages,i.page)}),n.subscribe(o.MORE_LOADED,r=>{l.renderMovieList(r),u(e,r.total_pages,i.page)})}const E=document.querySelector(".btn-more"),j=document.querySelector(".main-title");G(E,j);addEventListener("load",async()=>{await h(i.page)});const B=document.querySelector(".background-container");B.addEventListener("submit",async e=>{e.preventDefault();const t=document.querySelector(".search-input");await x(t.value.trim())});E.addEventListener("click",async()=>{i.page+=1,await R(i.page,i.searchQuery)});
