(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();const L="https://image.tmdb.org/t/p/w1920_and_h800_multi_faces/",E="https://media.themoviedb.org/t/p/w200",f="data:image/png;base64,";class C{movie;constructor(t){this.movie=t}render(){return`<div class="item">
    ...
    `}clearList(){this.movieList.innerHTML="",this.movieContainer.innerHTML=""}renderSkeleton(){this.clearList();for(let t=0;t<20;t++){const r=document.createElement("li"),s=new x;r.innerHTML=s.render(),this.movieList?.append(r)}}renderMovieList(t){t.results.forEach(r=>{const s=document.createElement("li"),n=new C(r);s.innerHTML=n.render(),this.movieList?.append(s)})}}const Y="data:image/png;base64,",U="data:image/png;base64,",A={clearHeader(){const e=document.querySelector(".background-container");e.innerHTML="",e.style.background="none",e.style.height="100px"},render(e){const t=document.querySelector(".background-container");t.innerHTML=`
      ...
      `,t.style.background=`url(${L}${e.backdrop_path}) no-repeat center center / cover`,t.style.removeProperty("height")},renderSearch(){const e=document.querySelector(".background-container");e.innerHTML=`${this.renderImage()}`},renderImage(){return`<div class="overlay" aria-hidden="true">
            ...
            </div>`}},p=new h;function b(){A.clearHeader(),A.renderSearch()}function R(e){A.clearHeader(),A.render(e)}function y(e){p.clearList(),p.renderMovieList(e)}const V="https://api.themoviedb.org/3",O="53582fed17d630068894f05310efec62";async function g(e,t,r=""){const s=new URLSearchParams({api_key:O,language:"ko-KR",page:String(t),...r&&{query:r}}),n=await fetch(`${V}/${e}?${s}`);if(!n.ok)throw new Error(`API 요청 실패: ${n.status}`);return await n.json()}const j="movie/popular",N="search/movie",S=new h;async function v(e,t){return t?await g(N,e,t):await g(j,e,t)}async function Q(e,t){try{return await v(e,t)}catch{throw new Error("영화 데이터를 불러오는 중 오류가 발생했습니다.")}}async function B(e){try{return S.renderSkeleton(),await v(e)}catch{throw new Error("영화 데이터를 불러오는 중 오류가 발생했습니다.")}}async function I(e,t){try{return S.renderSkeleton(),await v(e,t)}catch{throw new Error("영화 데이터를 불러오는 중 오류가 발생했습니다.")}}const w=new h;async function u(e,t,r){const s=document.querySelector(".main-title");s.textContent="지금 인기 있는 영화";const n=await B(e);R(n.results[0]),y(n),r(t,n)}async function k(e,t,r,s){const n=document.querySelector(".main-title");n.textContent=`"${t}" 검색 결과`;const o=await I(e,t);b(),o.results.length===0?w.showEmpty():y(o),s(r,o)}async function G(e,t,r,s){const n=await Q(e,t);w.renderMovieList(n),s(r,n)}let i=1,c="";const a=document.querySelector(".btn-more");addEventListener("load",async()=>{await u(i,a,l),document.querySelector(".background-container").addEventListener("submit",async t=>{if(t.preventDefault(),i=1,c=document.querySelector(".search-input").value.trim(),c===""){await u(i,a,l);return}await k(i,c,a,l),m()}),m()});function m(){document.querySelector(".logo").addEventListener("click",async()=>{i=1,c="",await u(i,a,l),m()})}a.addEventListener("click",async()=>{i+=1,await G(i,c,a,l)});function l(e,t){t.total_pages===i?e.style.display="none":e.style.display="block"}
